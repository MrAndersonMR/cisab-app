...
export default function CountyRegistration({ language = 'pt' }: { language: /* "en" | "es" | */ "pt" }) {
    ...
    return (
        ...
        <Container className="font-['Jost']">
            <div className="flex items-end">
                <div className="bg-[#7dc523] rounded-full p-3 text-white">{ getIconsByName('fa', 'FaCity', '32px') }</div>
                <h2 className="ml-4 p-2 rounded bg-[#40d9f1] text-white uppercase tracking-wider font-semibold">{ translations.countyRegistration[language] }</h2>
            </div>
            <Form>
                <h5 className="pl-4 text-[#7dc523] text-right uppercase tracking-widest p-2 mt-6 mb-4 border-b border-[#7dc523]">{ translations.account[language] }</h5>
                <Row className="mb-3">
                    <Form.Group as={Col} controlId="formAccount">
                        <Form.Label
                        >{ translations.countyAccount[language] }</Form.Label>
                        <Form.Control type="text" placeholder={ translations.insertCountyAccount[language] } value={ countyAccount } onChange={(e) => setCountyAccount(e.target.value)} />
                    </Form.Group>

                    <Form.Group as={Col} controlId="formPassword">
                        <Form.Label>{ translations.countyPassword[language] }</Form.Label>
                        <Form.Control type="password" placeholder={ translations.insertCountyPassword[language] } value={ countyPassword } onChange={(e) => setCountyPassword(e.target.value)}/>
                    </Form.Group>

                    <Form.Group as={Col} controlId="formConfirmPassword">
                        <Form.Label>{ translations.countyConfirmPassword[language] }</Form.Label>
                        <Form.Control type="password" placeholder={ translations.insertCountyConfirmPassword[language] } />
                    </Form.Group>
                </Row>

                <Form.Group className="mb-3" controlId="formCountyName">
                    <Form.Label>{ translations.countyName[language] }</Form.Label>
                    <Form.Control placeholder={ translations.insertCountyName[language] } />
                </Form.Group>
                
                <h5 className="pl-4 text-[#7dc523] text-right uppercase tracking-widest p-2 mt-12 mb-4 border-b border-[#7dc523]">{ translations.countyData[language] }</h5>
                ...
                <Row className="mb-3">
                    ...
                    <Form.Group as={Col} controlId="formPopulation">
                        ...
                        <Form.Control placeholder={ translations.insertPopulation[language] }/>
                    </Form.Group>
                </Row>
                ...
                <Row className="mb-3">
                    ...
                    <Form.Group as={Col} controlId="formCountyAnniversary">
                        <Form.Label>{ translations.countyAnniversary[language] }</Form.Label>
                        <Form.Control />
                    </Form.Group>

                    <Form.Group as={Col} controlId="formDistanceToCisab">
                        <Form.Label>{ translations.countyDistanceToCisab[language] }</Form.Label>
                        <Form.Control placeholder={ translations.insertCountyDistanceToCisab[language] }/>
                    </Form.Group>
                </Row>

                <Form.Group className="mb-3" controlId="countyNote">
                    <Form.Label>{ translations.note[language] }</Form.Label>
                    <Form.Control as="textarea" rows={3} placeholder={ translations.insertNote[language] }/>
                </Form.Group>

                <h5 className="pl-4 text-[#7dc523] text-right uppercase tracking-widest p-2 mt-12 mb-4 border-b border-[#7dc523]">{ translations.countyContact[language] }</h5>
                
                <Row className="mb-3">
                    <Form.Group  as={Col} xs={8} controlId="formAddress">
                        <Form.Label>{ translations.address[language] }</Form.Label>
                        <Form.Control placeholder={ translations.insertAddress[language] } />
                    </Form.Group>

                    <Form.Group  as={Col} controlId="formZipCode">
                        <Form.Label>{ translations.zipCode[language] }</Form.Label>
                        <Form.Control placeholder={ translations.insertZipCode[language] } />
                    </Form.Group>
                </Row>
                ...
                <Row className="mb-3">
                    ...
                    <Form.Group as={Col} controlId="formSocialMedias">
                        ...
                        <Form.Control placeholder={ translations.insertSocialMedias[language] }/>
                    </Form.Group>
                </Row>

                <h5 className="pl-4 text-[#7dc523] text-right uppercase tracking-widest p-2 mt-12 mb-4 border-b border-[#7dc523]">{ translations.contact[language] }</h5>
                ...
                <Button className="!bg-[#02aae9] !border-[#02aae9] !flex items-center uppercase" /* type="submit" */ onClick={() => {alert(countyAccount + " " + countyPassword)}}>
                    { getIconsByName('bs', 'BsSave') } &nbsp;
